  ...
  static void run() {
    group('PocketData.fromJSON()', () {
      test('should create object from json', () {
        ...
        expect(actualData.givenUrl,
            'http:\/\/www.grantland.com\/blog\/the-triangle\/post\/_\/id\/38347\/ryder-cup-preview',
            reason: 'givenUrl');
        expect(actualData.resolvedUrl,
            'http:\/\/www.grantland.com\/blog\/the-triangle\/post\/_\/id\/38347\/ryder-cup-preview\/resolved',
            reason: 'resolvedUrl');
        expect(actualData.givenTitle, 'The Massive Ryder Cup Preview - The Triangle Blog - Grantland',
            reason: 'givenTitle');
        ...
        expect(actualData.videos[0].sourceUrl, 'http:\/\/www.youtube.com\/v\/Er34PbFkVGk?version=3&hl=en_US&rel=0',
            reason: 'videos sourceUrl');
        ...
        expect(actualData.images[0].sourceUrl,
            'http:\/\/a.espncdn.com\/combiner\/i?img=\/photo\/2012\/0927\/grant_g_ryder_cr_640.jpg&w=640&h=360',
            reason: 'images sourceUrl');
